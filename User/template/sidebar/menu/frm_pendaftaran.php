    ...
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item active">
                ...
                <ul id="create_form" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
                    <li class="sidebar-item active"><a class="sidebar-link" href="?page=frm_pdftrn">Formulir Pendaftaran Siswa</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="?page=edt_dt">Edit Data Formulir</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="?page=sts_isi">Status Pengisian</a></li>
                </ul>
            </li>
            <!-- end Isi Formulir -->
            ...
            <li class="sidebar-item">
                ...
                <ul id="up_brks_pndkng" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="?page=up_kip">Upload KIP</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="?page=up_kks">Upload KKS</a></li>
                </ul>
            </li>
