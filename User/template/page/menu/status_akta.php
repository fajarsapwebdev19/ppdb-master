<div class="container-fluid p-0">
    ...
    <div class="row mb-2 mb-xl-3">
        <div class="title">
            <h3>Status Upload Akta Lahir</h3>
            <?php
                ...
                <?php
                    if(empty($status['file_akta']))
                    {
                        ...
                        ?>
                            <table width='35%'>
                                <tr>
                                    <td><em class="fas fa-upload"></em> Upload Akta Lahir</td>
                                    <td>:</td>
                                    <td>
                                        <?php
                                            if($status['status_upload_akta'] == "Belum")
                                            {
                                                ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            if($status['status_verifikasi_akta'] == "Antrian")
                                            {
                                                ?>
                                            ...
                                            elseif($status['status_verifikasi_akta'] == "Terima")
                                            {
                                                ?>
                                            ...
                                            elseif($status['status_verifikasi_akta'] == "Tolak")
                                            {
                                                ?>
