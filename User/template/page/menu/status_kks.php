<div class="container-fluid p-0">
    ...
    <div class="row mb-2 mb-xl-3">
        <div class="title">
            <h3>Status Upload KKS (Kartu Keluarga Sejahtera)</h3>
            <?php
                ...
                <?php
                    if(empty($status['file_kks']))
                    {
                        ...
                        ?>
                            <table width='35%'>
                                <tr>
                                    <td><em class="fas fa-upload"></em> Upload KKS</td>
                                    <td>:</td>
                                    <td>
                                        <?php
                                            if($status['status_upload_kks'] == "Belum")
                                            {
                                                ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            if($status['status_verifikasi_kks'] == "Antrian")
                                            {
                                                ?>
                                            ...
                                            elseif($status['status_verifikasi_kks'] == "Terima")
                                            {
                                                ?>
                                            ...
                                            elseif($status['status_verifikasi_kks'] == "Tolak")
                                            {
                                                ?>
