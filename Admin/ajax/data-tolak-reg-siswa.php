...
<table class="table table-hover table-sm table-striped nowrap" id="example">
    <thead>
        <tr>
            ...
            <th class="text-center">Tanggal Tolak</th>
        </tr>
    </thead>
    <tbody>
        <?php
            ...
            WHERE status_registrasi='Tolak' AND status_akun='Tidak Aktif'");
        ...
        <tr>
            ...
            <td class="text-center">
                <?= ($data_antri_user['tanggal_ditolak'] == "" || $data_antri_user['tanggal_ditolak'] == NULL) ? '' : date('d-m-Y', strtotime($data_antri_user['tanggal_ditolak'])) ?>
            </td>
        </tr>
        <?php endwhile; ?>
    </tbody>
