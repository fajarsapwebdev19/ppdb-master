<?php
    ...
    {
        ?>
            <nav class="navbar sticky-top navbar-expand navbar-light bg-dark-dev">
        <?php
    }else{
        ?>
            <nav class="navbar sticky-top navbar-expand navbar-light bg-<?= $apl['warna_header']?>">
        <?php
    }
?>
                ...
                <a class="nav-icon pe-md-0 dropdown-toggle" href="#" data-bs-toggle="dropdown">
                    <?php
                        if(empty($data_admin['foto']))
                        {
                            ...
                            {
                                ?>
                                    <img src="../Foto/foto_profile/man.png" class="avatar img-fluid rounded" alt="<?= $data_admin['nama'] ?>">
                                <?php
                            }
                            elseif($data_admin['jenis_kelamin'] == "Perempuan")
                            {
                                ?>
                                    <img src="../Foto/foto_profile/woman.png" class="avatar img-fluid rounded" alt="<?= $data_admin['nama'] ?>">
                                <?php
                            }
                        }else{
                            ?>
                                <img src="../Foto/foto_profile/<?= $data_admin['foto'] ?>" class="avatar img-fluid rounded" alt="<?= $data_admin['nama'] ?>">
                            <?php
                        }
                    ?>
                </a>
